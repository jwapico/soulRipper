...
- automatic backups for database
  also need to reorganize which things are initialized depending on what actions user is activating. i.e. we do not need to start slskd and other init if just dropping db, etc
