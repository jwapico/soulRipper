...
def update_db_with_spotify_playlist(sql_session, spotify_client: SpotifyClient, playlist_metadata):
    ...
    if playlist_row is None:
        playlist_row = add_playlist(sql_session, playlist_metadata['id'], playlist_metadata['name'], playlist_metadata['description'])
...
def update_db_with_spotify_liked_tracks(spotify_client, sql_session):
    ...
    if liked_playlist is None:
        liked_playlist = add_playlist(sql_session, spotify_id=None, name="SPOTIFY_LIKED_SONGS", description="User liked songs on Spotify - This playlist is generated by SoulRipper")
