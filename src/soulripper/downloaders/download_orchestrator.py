...
def download_liked_tracks_from_spotify_data(slskd_client: SoulseekDownloader, spotify_client: SpotifyClient, sql_session, output_path: str):
    ...
    PlaylistsRepository.add_playlist(sql_session, spotify_id=None, name="SPOTIFY_LIKED_SONGS", description="User liked songs on Spotify - This playlist is generated by SoulRipper", track_rows_and_data=track_rows_and_data)
...
def download_playlist_from_spotify_url(slskd_client: SoulseekDownloader, spotify_client: SpotifyClient, sql_session, playlist_url: str, output_path: str):
    ...
    PlaylistsRepository.add_playlist(sql_session, playlist_id, playlist_info["name"], playlist_info["description"], track_rows_and_data)
